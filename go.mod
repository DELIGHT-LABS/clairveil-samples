module github.com/DELIGHT-LABS/clairveil-samples
...
require (
	...
	github.com/DELIGHT-LABS/clairveil v0.0.0
...
// The local-only deposit prover and auditor helper are built against the
// sibling Clairveil Core checkout.
